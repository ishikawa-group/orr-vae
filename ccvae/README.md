...
| iter1     | 0.207±0.190            | 0.500±0.186       | 0.793±0.190            | 0.730±0.186         |
| iter2     | 0.190±0.063            | 0.427±0.058       | 0.810±0.063            | 0.803±0.058         |
| iter3     | 0.242±0.249            | 0.521±0.197       | 0.758±0.249            | 0.709±0.197         |


### 考察
- GANと同様に、条件ラベルの設定を中央値の上下で設定してしまったため、iter1以降の過電圧改善が限定的だった。
- ラベル設定は、再度検証し直す(進行中)。
- 条件ラベルを過電圧の上下だけで設定してしまうと、結局過電圧の改善に伴ってNi含有量が減少してしまう。過電圧ラベルとNi含有量ラベルを同時かつ、いい感じに指定する方法を考える必要があるかもしれない。
