...
parser.add_argument("--output_dir", type=str, default="/gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccvae/data",
                        help="Output directory (default: /gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccvae/data)")
