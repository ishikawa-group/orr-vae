...
def build_parser() -> argparse.ArgumentParser:
    ...
    sub.add_parser("generate-random", help="Run random structure generation")
    ...
    sub.add_parser("run-pipeline", help="Run full iterative pipeline")
...
def main(argv=None) -> int:
    ...
    mapping = {
        "generate-random": "orr_vae.workflows.generate_random_structures",
        ...
        "run-pipeline": "orr_vae.workflows.pipeline",
    }
