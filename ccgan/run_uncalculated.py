...
bulk_file = os.path.join(base_data_dir, "iter3_structures.json")
calculation_result_file = os.path.join(base_data_dir, "iter3_calculation_result.json")
...
# 一時ディレクトリを作成
temp_dir = f"/gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccgan/result/test/iter3_{uid}"
...
cmd = [
    "python3",
    "/gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccgan/02_calculate_overpotentials.py",  
    "--bulk_db", bulk_file,
    "--unique_id", uid,
