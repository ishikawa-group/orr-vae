...
SCRIPT_PATH = "/gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccvae_2/run_uncalculated.py"
MAX_COUNT = 128
...
for i in range(1, MAX_COUNT + 1):
    ...
    process = subprocess.Popen(
        ...
        cwd="/gs/fs/tga-ishikawalab/wakamiya/ORR_catalyst_generator/ccvae_2" 
    )
