...
1. `code/run_workflow.py` creates initial `iter0_structures.json` for Pt-Ni / Pt-Ti / Pt-Y (255 structures)
2. it then loops for `iter0..iter5`:
...
`run_tsubame_vae_parametric.sh`, which executes `../code/run_workflow.py`.
