#!/usr/bin/env python3
"""Submit many Pt-Ni / Pt-Ti / Pt-Y jobs from condition_list.csv."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Submit Pt-Ni_Pt-Ti_Pt-Y jobs to qsub")
    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--group", default="tga-ishikawalab")
    parser.add_argument("--job-prefix", default="VAE_PtNiPtTiPtY")
...
def build_env(
    *,
    ...
    env["GRID_Y"] = "4"
    env["GRID_Z"] = "6"
    env["INITIAL_NUM_STRUCTURES"] = "192"
    env["GENERATED_NUM_STRUCTURES"] = "192"
    env["BINARY_VARIANTS"] = "Pt-Ni,Pt-Ti,Pt-Y"
    env["ALL_ELEMENTS"] = "Pt,Ni,Ti,Y"
