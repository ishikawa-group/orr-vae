#!/usr/bin/env python3
"""Emit shell exports derived from mixed-alloy settings."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build shell exports for Pt-Ni_Pt-Ti_Pt-Y workflow")
    ...
    exports = {
        ...
        "BINARY_VARIANTS": ",".join(f"{a}-{b}" for a, b in cfg.generation.binary_variants),
    }
